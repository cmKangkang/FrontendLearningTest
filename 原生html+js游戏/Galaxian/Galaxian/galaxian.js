 ...
 * Date:2020-03-24
 * 
 * Description:Galaxian like HTML5 Game 
 */
...
var imageRepository = new function() {
	...
	this.spaceship.src = "imgs/ship1.png";
	this.bullet.src = "imgs/bullet.png";
	this.enemy.src = "imgs/enemy1.png";
	this.enemyBullet.src = "imgs/bullet_enemy1.png";
}
...
function Ship() {
	...
	//  */
	// this.fire = function() {
	// 	this.bulletPool.get(this.x+9.5, this.y, 3);
	 ...
	 */
	this.fire = function() {
		this.bulletPool.getTwo(this.x, this.y, 3,
		                       this.x+18, this.y, 3);
	};
}
...
function Game() {
	...
	this.muteAll = function() {
		this.laser.muted = !this.laser.muted;
		this.explosion.muted = !this.explosion.muted;
		this.backgroundAudio.muted = !this.backgroundAudio.muted;
		this.gameOverAudio.muted = !this.gameOverAudio.muted;
	} 
